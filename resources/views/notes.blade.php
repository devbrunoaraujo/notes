                    ...
                    <div class="card p-4">
                        <div class="row">
                            <div class="col">
                                ...
                                <small class="text-secondary"><span class="opacity-75 me-2">Created at:</span><strong>{{ date('d-m-Y, H:m:i', strtotime($note['created_at'])) }}</strong></small>
                                @if( $note['created_at'] != $note['updated_at'] )
                                <small class="text-secondary ms-5"><span class="opacity-75 me-2">Updated at:</span><strong>{{ date('d-m-Y, H:m:i', strtotime($note['updated_at'])) }}</strong></small>
                                @endif
                            </div>
